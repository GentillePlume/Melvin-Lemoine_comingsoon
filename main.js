...
setTimeout(function () {
    var typed = new Typed('#typed', {
        strings: ['développeur web', 'graphiste', 'entrepreneur', 'photographe', 'vidéaste', 'musicien', 'web designer', 'allié au féministe', 'perfectionniste', 'vegan', 'sportif', 'foufou', 'visionnaire', 'compositeur', 'amoureux des plantes', 'ambitieux', 'militant', 'ce que je suis', 'Melvin'],
        typeSpeed: 75,
        backDelay: 3000,
        fadeOut: true,
        loop: true
